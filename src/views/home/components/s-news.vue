        ...
        <div class="news-box">
            <template v-if="list.length > 0">
                <div class="news-box-top">
                    <div class="news-box-top-title"><router-link tag='a' :to="{ path: '/news-detail', query: { id: list[0].id } }">{{ list[0].name }}</router-link></div>
                ...
                <ul class="news-list">
                    <template v-for="(item, index) in list">
                        <template v-if="index > 0">
                            <li><router-link tag='a' :to="{ path: '/news-detail', query: { id: item.id } }">{{ item.name }}</router-link></li>
                        </template>
                    </template>
                </ul>
            </template>
