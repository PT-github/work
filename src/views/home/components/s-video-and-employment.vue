<template>
    <div class="s-video-and-employment clearfix">
        <div class="fl">
            <div class="title"></div>
        ...
        <el-dialog @close="close" :close-on-click-modal="false" :close-on-press-escape="false"  :visible.sync="dialogVisible" width="1000px">
