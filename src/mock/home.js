...
export default {
    ...
    searchMail: () => {
        return Mock.mock({
            ...
            "message": '成功',
            "list|20": [
                { "id|+1": 1, "name|1": ['消息内容消息内','消息内容消息内2消息内容消息内2消息内容消息内2消息内容消息内2消息内容消息内2消息内容消息内2','消息内容消息内3消息内容消息内3消息内容消息内3消息内容消息内3消息内容消息内3消息内容消息内3消息内容消息内3消息内容消息内3消息内容消息内3消息内容消息内3消息内容消息内3消息内容消息内3消息内容消息内3消息内容消息内3消息内容消息内3消息内容消息内3消息内容消息内3消息内容消息内3消息内容消息内3']}
            ]
        })
    },
    /**
